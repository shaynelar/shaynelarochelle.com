	...
	return (
		<Layout id="home" as="section" className="hero bg-primary p-4 sm:p-8">
			<div className="flex flex-col">
				<Heading className="2xl:text-8xl lg:text-7xl text-5xl font-bold text-blue-100 my-4 lg:my-8 xl:my-12 text-white">
					<span className="text-blue-500">Shayne</span><span className="text-fuchsia-500"> LaRochelle</span>
				</Heading>
