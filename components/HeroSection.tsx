	...
	return (
		<FlexContainer as="section" className="hero bg-primary p-2">
			<div className="flex flex-col lg:flex-row">
				<div>
					<Heading className="2xl:text-8xl lg:text-7xl text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-purple-700 via-purple-400 to-purple-100 my-10 leading-14">
						Shayne LaRochelle
					</Heading>
