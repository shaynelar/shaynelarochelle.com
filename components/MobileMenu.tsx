			...
			<Menu>
				{({ isExpanded }) => {
					...
					return (
						<>
							<MenuButton
								className="inline-flex items-center justify-center p-1 transition bg-white text-dark w-14 h-14 focus:outline-none rounded-full "
								onClick={() => {
			...
			{isExpanded ? (
				...
				>
					<motion.div
						...
						className="flex flex-col h-full border-t border-gray-200 w-screen z-10 bg-primary overflow-hidden"
					>
